//
//  TableViewCell_ItemStyle_Imgs_2.m
//  TableViewDemo
//
...
#import "TableViewCell_ItemStyle_Imgs_2.h"

@interface TableViewCell_ItemStyle_Imgs_2()
...
@implementation TableViewCell_ItemStyle_Imgs_2
              ...
              reuseIdentifier:(nullable NSString *)reuseIdentifier
{
    ...
    if(self != nil){
        ...
        for(int i=0; i<5; i+=1){ // 预先创建，避免在滑动列表时新建控件，否则会造成性能问题
